...
public class Assignment2 {
	public static void main(String[] args){
	    ...
	    for(int i=1; i<=database.size(); i++){
	        ArrayList<String> result = subLists(database, i);
	...
	public static ArrayList<String> subLists(ArrayList<String> elements, int lengthOfList){
	    ArrayList<String> allLists = new ArrayList<String>();
	    if(lengthOfList == 1)
	    	return elements;
	    else {
	        ArrayList<String> allSublists = subLists(elements, lengthOfList - 1);
